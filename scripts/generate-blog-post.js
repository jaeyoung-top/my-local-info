...
첫 문장은 절대 "안녕하세요"나 "이번에는" 으로 시작하지 마세요. 장면 묘사나 질문으로 시작하세요.`
  ...
  {
    name: '오해교정형',
    instruction: `사람들이 흔히 잘못 알고 있는 부분을 바로잡는 스타일로 씁니다.
"많은 분이 이렇게 알고 있지만, 실제로는..." 형태로 자연스럽게 시작하세요.
절대로 "팩트체크 1", "팩트체크 2" 같은 번호 매기기 구조를 사용하지 마세요.
공식 안내문에는 없지만 실제 신청자들이 겪는 현실적인 이슈를 중심으로 구성합니다.
섹션 제목은 "~했더니", "~라는 사실" 같은 자연스러운 문장 형태로 쓰세요.`
  },
  {
    name: '상황별 시나리오형',
