...
const faqs = [
  ...
  {
    q: "블로그 글은 어떻게 작성되나요?",
    a: "각 혜택·지원금의 공식 원문을 직접 검토한 뒤, 주민 입장에서 실제로 필요한 내용 — 신청 자격 판단법, 예상 수령액, 탈락 이유, 다른 혜택과의 중복 여부 — 을 중심으로 편집합니다. 공식 안내문에는 적혀 있지 않지만 실제 신청 과정에서 자주 발생하는 문제도 최대한 담으려고 합니다. 모든 글에는 원문 출처 링크가 포함되며, 정책 변경 시 업데이트합니다."
  },
  {
      ...
      <main className="max-w-4xl mx-auto px-6 pb-24 space-y-10">
        ...
        <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <p className="text-gray-600 leading-8 text-lg break-keep mb-4">
            송파구에 살면서 느낀 점이 있습니다. 구청 홈페이지, 서울시 사이트, 복지로, 정부24 — 좋은 지원 제도가
            정말 많은데 정작 어디에 있는지 찾기가 너무 어렵습니다. 첫째를 낳고 나서 받을 수 있었던 바우처를
            신청 기간이 지나 뒤늦게 알게 됐던 경험도 있습니다.
          </p>
          <p className="text-gray-600 leading-8 text-lg break-keep mb-4">
            그래서 만들었습니다. 흩어진 정보를 한 곳에 모으고, 단순한 링크 나열이 아니라 "이 혜택이 나한테 해당하는지",
            "실제로 얼마 받을 수 있는지", "신청할 때 뭘 조심해야 하는지"를 알 수 있도록 정리합니다.
            육아 가정, 취업 준비생, 소상공인 등 지원이 필요한 분들이 놓치는 혜택 없이 적시에 신청하도록
            돕는 것이 이 서비스의 목표입니다.
          </p>
          <p className="text-gray-600 leading-8 text-lg break-keep">
            여기에 FM코리아·퀘이사존·뽐뿌·루리웹·개드립·아카라이브 등 커뮤니티의
            <strong> 핫딜 정보</strong>도 함께 제공합니다. 가격 비교와 가격 흐름까지 한 번에 볼 수 있습니다.
          </p>
        </section>
